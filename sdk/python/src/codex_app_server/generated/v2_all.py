...
class ThreadRuntimeCwdUpdateParams(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    cwd: str
...
class ThreadRuntimeCwdUpdateResponse(BaseModel):
    pass
    model_config = ConfigDict(
        populate_by_name=True,
    )
...
class ThreadRuntimeCwdUpdateRequest(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    id: RequestId
    method: Annotated[
        Literal["thread/runtimeCwd/update"],
        Field(title="Thread/runtimeCwd/updateRequestMethod"),
    ]
