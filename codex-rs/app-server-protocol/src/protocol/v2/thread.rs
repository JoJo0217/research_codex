...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadRuntimeCwdUpdateParams {
    pub thread_id: String,
    pub cwd: PathBuf,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadRuntimeCwdUpdateResponse {}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadBackgroundTerminalTerminateParams {
    pub thread_id: String,
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadBackgroundTerminalTerminateResponse {}
