...
pub(crate) struct ThreadSessionState {
    ...
    /// Mutable runtime cwd for shell execution and per-turn overrides.
    pub(crate) cwd: AbsolutePathBuf,
    /// Stable cwd used for config, skills, plugin, and hook discovery. Older
    /// cached sessions leave this unset and fall back to `cwd`.
    pub(crate) discovery_cwd: Option<AbsolutePathBuf>,
