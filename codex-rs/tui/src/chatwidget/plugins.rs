...
impl ChatWidget {
    ...
    fn marketplace_remove_confirmation_popup_params(
        ...
        let cwd_for_remove = self.discovery_cwd().to_path_buf();
        let cwd_for_cancel = self.discovery_cwd().to_path_buf();
        let cwd_for_on_cancel = self.discovery_cwd().to_path_buf();
